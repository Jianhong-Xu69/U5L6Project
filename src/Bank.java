public class Bank
{
    ...
    public Bank()
    {
        onHandCash = 0; //bank money at bank at that time
        vendorAccountBalance = 0; //how much money a store has deposited
        HIGH_BALANCE_AMT = 500; //borrowing limit
        HIGH_BALANCE_FEE = 5; //borrowing fee if above limit
    }
     ...
     */
    public void makePayment(CreditCard card, int payment) //pays off the bill to the bank
    {
